...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    /* Decidi testar tres tipos de entradas invalidas: string, array e booleano */
    ...
    /* Para testar esse requisito, pode-se utilizar o comprimento do array retornado por object.keys(), visto que esse array é composto pelas chaves do objeto, ele tera comprimento igual ao numero de propriedades do objeto */
    ...
    /* Segundo a documentacao do Jest, um matcher para comparar numeros de ponto flutuante é o .toBeCloseTo(numero, quantidadeDigitos?). Portanto, ele é ideal para a solucao desse requisito e o proximo.
    Ref: https://jestjs.io/docs/expect#tobeclosetonumber-numdigits */
    expect(circle(2).circumference).toBeCloseTo(3.14 * 2 * 2);
